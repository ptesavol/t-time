...
public class FeedTravelUnitForm extends Form
{
...
private static FeedTravelUnitForm _instance;

private FeedTravelUnitForm()
	{
...
public static FeedTravelUnitForm instance(DataObject obj)
	{
	if (_instance==null)
		{
		_instance=new FeedTravelUnitForm();
		}
