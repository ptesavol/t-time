...
public class AddProductForm extends AddForm implements ItemStateListener
{
private static AddProductForm _instance=null;
...
private AddProductForm()
	{
	super(Props.get("add_product_title")); 
...
public static AddProductForm instance()
	{
	if (_instance==null)
		{
		_instance=new AddProductForm();
		}

	_instance.nameField.setString("");
	_instance.productIdField.setString("");
	_instance.unitField.setString("");
	_instance.buyEurosField.setString("");
	_instance.buyCentsField.setString("");
	_instance.sellEurosField.setString("");
	_instance.sellCentsField.setString("");
	_instance.sellTaxedEurosField.setString("");
	_instance.sellTaxedCentsField.setString("");
	
	_instance.vatPercentField.setString("");
	_instance.inStockIntegerField.setString("");
	_instance.inStockDecimalField.setString("");
