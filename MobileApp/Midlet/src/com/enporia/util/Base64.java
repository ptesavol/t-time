...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static int encodeText(ByteArrayHolder holder)
    {
    	byte [] source=holder.data;
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    /**
     * Check line for a bad characters.
     */
    public static boolean check(byte[] line)
    {
        ...
        {
        	sbiCrop = (byte)(line[i] & 0x7f); // Only the low seven bits
            sbiDecode = DECODABET[ sbiCrop ];
        	
            if( sbiDecode < WHITE_SPACE_ENC ) return false;
        }
